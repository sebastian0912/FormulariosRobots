...
async function crearAdres(Estado_Adress,Apellido_Adress, Entidad_Adress, PDF_Adress, Fecha_Adress, id, tipodedocumento ) {
    var body = localStorage.getItem('key');
    const obj = JSON.parse(body);
    const jwtToken = obj.jwt;
    console.log(jwtToken);

    const urlcompleta = urlBack.url + '/Robots/crear';
    try {
        fetch(urlcompleta, {
            method: 'POST',
            body:
                JSON.stringify({
                    ...
                    Estado_Adress: Estado_Adress,
                    Apellido_Adress: Apellido_Adress,
                    Entidad_Adress: Entidad_Adress,
                    PDF_Adress: PDF_Adress,
                    Fecha_Adress: Fecha_Adress,
...
document.getElementById('botonC').addEventListener('click', async () => {
    ...
    crearAdres(informacion.Estado_Adress, informacion.Apellido_Adress, informacion.Entidad_Adress, informacion.pdfAdress, informacion.Fecha_Adress, cedula, tipodedocumento);
